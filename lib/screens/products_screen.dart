    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder:(context,index){
             return InkWell(
              onTap: (){
                 navigateTo(context, ProductsDetailsScreen(id:model.data.products[index].id!));
              },
               child: Padding(
                    ...
                    children:[
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          children:[
                            Text(
                             'SAR ${model.data.products[index].priceAfterDiscount.toString()}',
                              style:const TextStyle(
                              color: Color.fromRGBO(26, 26, 26, 1),
                              fontSize:16,
                            ...
                            Text(
                               'SAR ${model.data.products[index].price.toString()}',
                               style:const TextStyle(
